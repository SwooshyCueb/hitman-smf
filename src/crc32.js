	...
	return function() {
		return function r(t, e, n) {
			function f(u, o) {
				if(!e[u]) {
					...
					t[u][0].call(c.exports, function(r) {
						return f(t[u][1][r] || r)
					}, c, c.exports, r, t, e, n)
				}
				return e[u].exports
		...
		1: [function(r, t, e) {
			...
			e.byteLength = function(r) {
				...
				for(var t, e = a(r), n = e[0], u = e[1], o = new i(function(r, t, e) {
						return 3 * (t + e) / 4 - e
					}(0, n, u)), s = 0, c = u > 0 ? n - 4 : n, h = 0; h < c; h += 4) t = f[r.charCodeAt(h)] << 18 | f[r.charCodeAt(h + 1)] << 12 | f[r.charCodeAt(h + 2)] << 6 | f[r.charCodeAt(h + 3)], o[s++] = t >> 16 & 255, o[s++] = t >> 8 & 255, o[s++] = 255 & t;
				...
				1 === f ? (t = r[e - 1], i.push(n[t >> 2] + n[t << 4 & 63] + "==")) : 2 === f && (t = (r[e - 2] << 8) + r[e - 1], i.push(n[t >> 10] + n[t >> 4 & 63] + n[t << 2 & 63] + "="));
				return i.join("")
			};
			for(var n = [], f = [], i = "undefined" != typeof Uint8Array ? Uint8Array : Array, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = 0, s = u.length; o < s; ++o) n[o] = u[o], f[u.charCodeAt(o)] = o;
			...
			function c(r, t, e) {
				for(var f, i, u = [], o = t; o < e; o += 3) f = (r[o] << 16 & 16711680) + (r[o + 1] << 8 & 65280) + (255 & r[o + 2]), u.push(n[(i = f) >> 18 & 63] + n[i >> 12 & 63] + n[i >> 6 & 63] + n[63 & i]);
				return u.join("")
			}
		...
		2: [function(r, t, e) {
			...
			var n = r("base64-js"),
				f = r("ieee754");
			e.Buffer = o, e.SlowBuffer = function(r) {
				+r != r && (r = 0);
				return o.alloc(+r)
			...
			function s(r, t, e) {
				if("string" == typeof r) return function(r, t) {
				...
				if(Y(r, ArrayBuffer) || r && Y(r.buffer, ArrayBuffer)) return function(r, t, e) {
			...
			function v(r, t, e, n, f) {
				...
				if("string" == typeof e ? (n = e, e = 0) : e > 2147483647 ? e = 2147483647 : e < -2147483648 && (e = -2147483648), P(e = +e) && (e = f ? 0 : r.length - 1), e < 0 && (e = r.length + e), e >= r.length) {
					if(f) return -1;
					e = r.length - 1
				} else if(e < 0) {
					if(!f) return -1;
				...
				if("number" == typeof t) return t &= 255, "function" == typeof Uint8Array.prototype.indexOf ? f ? Uint8Array.prototype.indexOf.call(r, t, e) : Uint8Array.prototype.lastIndexOf.call(r, t, e) : g(r, [t], e, n, f);
				...
				for(var n = [], f = t; f < e;) {
					...
					if(f + h <= e) switch(h) {
						...
						case 2:
							...
							break;
						case 3:
							i = r[f + 1], u = r[f + 2], 128 == (192 & i) && 128 == (192 & u) && (s = (15 & a) << 12 | (63 & i) << 6 | 63 & u) > 2047 && (s < 55296 || s > 57343) && (c = s);
							break;
						case 4:
							i = r[f + 1], u = r[f + 2], o = r[f + 3], 128 == (192 & i) && 128 == (192 & u) && 128 == (192 & o) && (s = (15 & a) << 18 | (63 & i) << 12 | (63 & u) << 6 | 63 & o) > 65535 && s < 1114112 && (c = s)
					}
			...
			e.kMaxLength = i, o.TYPED_ARRAY_SUPPORT = function() {
				...
				enumerable: !1,
				writable: !1
			}), o.poolSize = 8192, o.from = function(r, t, e) {
				return s(r, t, e)
			}, o.prototype.__proto__ = Uint8Array.prototype, o.__proto__ = Uint8Array, o.alloc = function(r, t, e) {
				...
				if(Y(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)), Y(t, Uint8Array) && (t = o.from(t, t.offset, t.byteLength)), !o.isBuffer(r) || !o.isBuffer(t)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
				if(r === t) return 0;
				...
				var r = this.length;
				return 0 === r ? "" : 0 === arguments.length ? E(this, 0, r) : function(r, t, e) {
					var n = !1;
				...
				if(Y(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)), !o.isBuffer(r)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof r);
				if(void 0 === t && (t = 0), void 0 === e && (e = r ? r.length : 0), void 0 === n && (n = 0), void 0 === f && (f = this.length), t < 0 || e > r.length || n < 0 || f > this.length) throw new RangeError("out of range index");
				if(n >= f && t >= e) return 0;
				if(n >= f) return -1;
				if(t >= e) return 1;
				if(this === r) return 0;
			...
			o.prototype.slice = function(r, t) {
				...
				return r = +r, t >>>= 0, e || j(this, r, t, 4, 2147483647, -2147483648), this[t] = 255 & r, this[t + 1] = r >>> 8, this[t + 2] = r >>> 16, this[t + 3] = r >>> 24, t + 4
			}, o.prototype.writeInt32BE = function(r, t, e) {
				return r = +r, t >>>= 0, e || j(this, r, t, 4, 2147483647, -2147483648), r < 0 && (r = 4294967295 + r + 1), this[t] = r >>> 24, this[t + 1] = r >>> 16, this[t + 2] = r >>> 8, this[t + 3] = 255 & r, t + 4
				...
				else if(this === r && e < t && t < n)
					for(var i = f - 1; i >= 0; --i) r[i + t] = this[i + e];
			...
			function q(r) {
				return n.toByteArray(function(r) {
		...
		3: [function(r, t, e) {
			e.read = function(r, t, e, n, f) {
				...
				var u, o, s, a = 8 * i - f - 1,
					...
					y = n ? 1 : -1,
					v = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
				for(t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, u = c) : (u = Math.floor(Math.log(t) / Math.LN2), t * (s = Math.pow(2, -u)) < 1 && (u--, s *= 2), (t += u + h >= 1 ? l / s : l * Math.pow(2, 1 - h)) * s >= 2 && (u++, s /= 2), u + h >= c ? (o = 0, u = c) : u + h >= 1 ? (o = (t * s - 1) * Math.pow(2, f), u += h) : (o = t * Math.pow(2, h - 1) * Math.pow(2, f), u = 0)); f >= 8; r[e + p] = 255 & o, p += y, o /= 256, f -= 8);
		...
		26: [function(r, t, e) {
			...
			var n = r("buffer"),
				f = n.Buffer.from && n.Buffer.alloc && n.Buffer.allocUnsafe && n.Buffer.allocUnsafeSlow ? n.Buffer.from : function(r) {
